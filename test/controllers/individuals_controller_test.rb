...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { about: @individual.about, age: @individual.age, city: @individual.city, name: @individual.name, needs: @individual.needs, surname: @individual.surname, user_id: @individual.user_id }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { about: @individual.about, age: @individual.age, city: @individual.city, name: @individual.name, needs: @individual.needs, surname: @individual.surname, user_id: @individual.user_id }
    assert_redirected_to individual_path(assigns(:individual))
  end
