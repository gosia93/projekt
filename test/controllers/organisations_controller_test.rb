...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { about: @organisation.about, city: @organisation.city, name: @organisation.name, regon: @organisation.regon, user_id: @organisation.user_id }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { about: @organisation.about, city: @organisation.city, name: @organisation.name, regon: @organisation.regon, user_id: @organisation.user_id }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
